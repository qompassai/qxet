<!--------------- /qompassai/qxet/README.md -------------->
<!--------------------Qompass AI QXet -------------------->
<!-- Copyright (C) 2025 Qompass AI, All rights reserved -->
<!-- ----------------------------------------------------->

<h1 align="center">Qompass AI QXet</h1>

<h2 align="center">Quality AI eXchange</h2>

![Repository Views](https://komarev.com/ghpvc/?username=qompassai-qxet)
![GitHub all releases](https://img.shields.io/github/downloads/qompassai/qxet/total?style=flat-square)
...
```mermaid 
flowchart TD
A[Your Files (Models/Datasets)] --> B[QXet Chunk Deduplication]
B --> C[Content-Addressed Storage]
 B --> D[Local Disk Cache]
C --> E[LFS Bridge (Legacy)]
E --> F[Hugging Face Hub / Modern QXet APIs]
F --> G[Users Collaborate]
      ```

  </div>

  <div align="center">
  <img src="https://www.github.com/qompassai/svg/assets/qxet.svg" alt="QXet Visual TLDR" width="180">
</div>
...
```sh
curl -fsSL https://raw.githubusercontent.com/qompassai/qxet/main/scripts/quickstart.sh | sh
```
  </div>
...
#!/bin/sh
# /qompassai/qxet/scripts/quickstart.sh
# Qompass AI Qxet Quick Start
# Copyright (C) 2025 Qompass AI, All rights reserved
####################################################
set -eu
IFS=' 
...
EOF
printf '\n╭────────────────────────────────────────────╮\n'
printf   '│      QXet • Quality AI Data eXchange       │\n'
printf   '│          Qompass AI Quickstart             │\n'
printf   '╰────────────────────────────────────────────╯\n'
printf '   (c) 2025 Qompass AI. All rights reserved\n\n'
...
for f in "$RELEASE_DIR"/*; do
  [ -x "$f" ] && [ ! -d "$f" ] && cp "$f" "$CARGO_BIN_DIR/"
done
if ! command -v zig >/dev/null 2>&1; then
  cargo install zig --locked --force 2>/dev/null || true
fi
echo "✅ Qompass AI Qxet Quickstart complete!"
echo "→ Please restart your terminal or run 'export PATH=\"$BIN_DIR:\$PATH\"' to update your PATH."
rm -f "/tmp/rust_menu.$USER"
exit 0 
</pre> </details> <p>Or, <a href="https://github.com/qompassai/qxet/blob/main/scripts/quickstart.sh" target="_blank">View the quickstart script</a>.</p>
...
<div align="center">
  <img src="https://www.github.com/qompassai/svg/assets/monero-qr.png" alt="Monero QR Code" width="180">
</div>
